...
const Header = ({ data, onLogout }) => {
  return (
    <header className="flex flex-col mb-5 sm:flex-row items-start sm:items-center justify-between gap-4 p-6 bg-gradient-to-r from-[#eef2ff] via-[#e0e7ff] to-[#f0f4ff] shadow-lg rounded-2xl">
      ...
      <button
        onClick={onLogout}
        className="flex items-center gap-2 bg-red-500 hover:bg-red-600 text-white px-5 py-3 rounded-full font-semibold text-base sm:text-lg transition-all duration-300 shadow-md hover:shadow-lg"
      >
